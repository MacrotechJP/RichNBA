class Scraping
  ...
  #     elementimage.zip(elementprice,elementname).each do |eleimage, eleprice,elename|
  #       Item.create(name:elename.inner_text,siteurl:eleimage.get_attribute(:href),price:eleprice.inner_text.gsub(",","").gsub("円",""),ecsite_id:4)
  #     end
